...
// ═══════════════════════════════════════════════════════════════
//  P8-04 기억 파괴자 (memory_breaker) — 30 스킬
// ═══════════════════════════════════════════════════════════════

const memoryBreakerSkills: SkillSeed[] = [
  // ── 기본 스킬 (Lv.1~20) — 10개 ────────────────────────────────
  { code: 'MB_001', name: '기억 분쇄', description: '대상의 기억을 파쇄하여 에테르 피해', class: 'memory_breaker', tier: 0, type: 'active', element: 'ether', damage: 45, damageScale: 1.8, mpCost: 20, cooldown: 6, castTime: 0.5, range: 3, targetType: 'single', aoeRadius: null, effect: null, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: [], requiredLevel: 1 },
  { code: 'MB_002', name: '파편 투척', description: '봉인 파편을 투사체로 발사', class: 'memory_breaker', tier: 0, type: 'active', element: 'ether', damage: 35, damageScale: 1.5, mpCost: 15, cooldown: 4, castTime: 0.3, range: 6, targetType: 'single', aoeRadius: null, effect: null, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: [], requiredLevel: 1 },
  { code: 'MB_003', name: '망각의 일격', description: '적의 단기 기억을 지워 혼란 유발 (3초)', class: 'memory_breaker', tier: 0, type: 'active', element: 'ether', damage: 50, damageScale: 2.0, mpCost: 25, cooldown: 10, castTime: 0.8, range: 3, targetType: 'single', aoeRadius: null, effect: { status: 'confusion', duration: 3 }, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: [], requiredLevel: 5 },
  { code: 'MB_004', name: '에테르 흡인', description: '적의 에테르를 흡수하여 MP 회복', class: 'memory_breaker', tier: 0, type: 'active', element: 'ether', damage: 30, damageScale: 1.2, mpCost: 0, cooldown: 15, castTime: 0.5, range: 3, targetType: 'single', aoeRadius: null, effect: { mpRestore: 30 }, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: [], requiredLevel: 8 },
  { code: 'MB_005', name: '기억 보호막', description: '파괴된 기억으로 보호막 생성', class: 'memory_breaker', tier: 0, type: 'active', element: 'ether', damage: 0, damageScale: 0, mpCost: 30, cooldown: 20, castTime: 1.0, range: 0, targetType: 'self', aoeRadius: null, effect: { shield: 0.1 }, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: [], requiredLevel: 10 },
  { code: 'MB_006', name: '파편 강화', description: '봉인 파편의 힘으로 공격력 증가', class: 'memory_breaker', tier: 0, type: 'passive', element: 'ether', damage: 0, damageScale: 0, mpCost: 0, cooldown: 0, castTime: 0, range: 0, targetType: 'self', aoeRadius: null, effect: { attackBonus: 0.08 }, maxLevel: 5, levelScaling: PASSIVE_SCALING, prerequisites: [], requiredLevel: 3 },
  { code: 'MB_007', name: '망각 저항', description: '기억 소실 계열 상태이상 저항 증가', class: 'memory_breaker', tier: 0, type: 'passive', element: 'ether', damage: 0, damageScale: 0, mpCost: 0, cooldown: 0, castTime: 0, range: 0, targetType: 'self', aoeRadius: null, effect: { resistMemoryLoss: 0.3 }, maxLevel: 5, levelScaling: PASSIVE_SCALING, prerequisites: [], requiredLevel: 6 },
  { code: 'MB_008', name: '파괴자의 본능', description: '적 HP 30% 이하 시 크리 확률 15% 증가', class: 'memory_breaker', tier: 0, type: 'passive', element: 'ether', damage: 0, damageScale: 0, mpCost: 0, cooldown: 0, castTime: 0, range: 0, targetType: 'self', aoeRadius: null, effect: { critBonusOnLowHp: 0.15, threshold: 0.3 }, maxLevel: 5, levelScaling: PASSIVE_SCALING, prerequisites: [], requiredLevel: 12 },
  { code: 'MB_009', name: '기억 연쇄', description: '스킬 적중 시 20% 확률로 추가 타격', class: 'memory_breaker', tier: 0, type: 'passive', element: 'ether', damage: 0, damageScale: 0, mpCost: 0, cooldown: 0, castTime: 0, range: 0, targetType: 'self', aoeRadius: null, effect: { chainHitChance: 0.2 }, maxLevel: 5, levelScaling: PASSIVE_SCALING, prerequisites: [], requiredLevel: 15 },
  { code: 'MB_010', name: '안개 적응', description: '안개해 지역에서 전투력 5% 증가', class: 'memory_breaker', tier: 0, type: 'passive', element: 'ether', damage: 0, damageScale: 0, mpCost: 0, cooldown: 0, castTime: 0, range: 0, targetType: 'self', aoeRadius: null, effect: { mistSeaBonus: 0.05 }, maxLevel: 5, levelScaling: PASSIVE_SCALING, prerequisites: [], requiredLevel: 18 },

  // ── 1차 전직: 봉인 해체자 (Lv.30+) — 10개 ──────────────────────
  { code: 'MB_011', name: '봉인 균열', description: '대상의 방어 봉인 해체, 방어력 20% 감소 (10초)', class: 'memory_breaker', tier: 1, type: 'active', element: 'ether', damage: 60, damageScale: 2.2, mpCost: 40, cooldown: 18, castTime: 0.8, range: 3, targetType: 'single', aoeRadius: null, effect: { debuff: 'defense_down', value: 0.2, duration: 10 }, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: ['MB_001'], requiredLevel: 30 },
  { code: 'MB_012', name: '파편 폭발', description: '범위 내 적에게 봉인 파편 폭발 피해', class: 'memory_breaker', tier: 1, type: 'active', element: 'ether', damage: 55, damageScale: 2.0, mpCost: 45, cooldown: 14, castTime: 1.0, range: 4, targetType: 'aoe', aoeRadius: 3, effect: null, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: ['MB_002'], requiredLevel: 32 },
  { code: 'MB_013', name: '기억 침식', description: 'DoT — 6초간 매초 공격력 50% 피해', class: 'memory_breaker', tier: 1, type: 'active', element: 'ether', damage: 30, damageScale: 0.5, mpCost: 35, cooldown: 12, castTime: 0.5, range: 4, targetType: 'single', aoeRadius: null, effect: { dot: true, duration: 6, tickDamageScale: 0.5 }, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: ['MB_003'], requiredLevel: 34 },
  { code: 'MB_014', name: '봉인 해체', description: '적의 버프 1개 제거 + 공격력 150% 피해', class: 'memory_breaker', tier: 1, type: 'active', element: 'ether', damage: 70, damageScale: 2.5, mpCost: 50, cooldown: 20, castTime: 1.0, range: 3, targetType: 'single', aoeRadius: null, effect: { dispel: 1 }, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: ['MB_011'], requiredLevel: 36 },
  { code: 'MB_015', name: '기억 전이', description: '적에게 받은 피해의 30%를 되돌림 (5초)', class: 'memory_breaker', tier: 1, type: 'active', element: 'ether', damage: 0, damageScale: 0, mpCost: 40, cooldown: 25, castTime: 0.5, range: 0, targetType: 'self', aoeRadius: null, effect: { reflect: 0.3, duration: 5 }, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: ['MB_005'], requiredLevel: 38 },
  { code: 'MB_016', name: '봉인 공명', description: '봉인 관련 적에게 피해 15% 증가', class: 'memory_breaker', tier: 1, type: 'passive', element: 'ether', damage: 0, damageScale: 0, mpCost: 0, cooldown: 0, castTime: 0, range: 0, targetType: 'self', aoeRadius: null, effect: { sealBonusDamage: 0.15 }, maxLevel: 5, levelScaling: PASSIVE_SCALING, prerequisites: ['MB_006'], requiredLevel: 30 },
  { code: 'MB_017', name: '파괴자의 집중', description: '3연속 공격 시 다음 스킬 크리 확정', class: 'memory_breaker', tier: 1, type: 'passive', element: 'ether', damage: 0, damageScale: 0, mpCost: 0, cooldown: 0, castTime: 0, range: 0, targetType: 'self', aoeRadius: null, effect: { guaranteedCritAfter: 3 }, maxLevel: 5, levelScaling: PASSIVE_SCALING, prerequisites: ['MB_008'], requiredLevel: 33 },
  { code: 'MB_018', name: '기억 착취', description: '디버프 상태 적에게 피해 10% 증가', class: 'memory_breaker', tier: 1, type: 'passive', element: 'ether', damage: 0, damageScale: 0, mpCost: 0, cooldown: 0, castTime: 0, range: 0, targetType: 'self', aoeRadius: null, effect: { debuffExploit: 0.1 }, maxLevel: 5, levelScaling: PASSIVE_SCALING, prerequisites: ['MB_009'], requiredLevel: 35 },
  { code: 'MB_019', name: '에테르 과부하', description: '스킬 피해 10% 증가, MP 소모 5% 증가', class: 'memory_breaker', tier: 1, type: 'passive', element: 'ether', damage: 0, damageScale: 0, mpCost: 0, cooldown: 0, castTime: 0, range: 0, targetType: 'self', aoeRadius: null, effect: { damageUp: 0.1, mpCostUp: 0.05 }, maxLevel: 5, levelScaling: PASSIVE_SCALING, prerequisites: ['MB_006'], requiredLevel: 37 },
  { code: 'MB_020', name: '망각의 갑옷', description: '기억 파괴 스킬 사용 시 보호막 생성 (최대 HP 5%)', class: 'memory_breaker', tier: 1, type: 'passive', element: 'ether', damage: 0, damageScale: 0, mpCost: 0, cooldown: 0, castTime: 0, range: 0, targetType: 'self', aoeRadius: null, effect: { shieldOnBreak: 0.05 }, maxLevel: 5, levelScaling: PASSIVE_SCALING, prerequisites: ['MB_007'], requiredLevel: 40 },

  // ── 2차 전직: 허공 파괴자 (Lv.50+) — 8개 ──────────────────────
  { code: 'MB_021', name: '허공 절단', description: '기억의 공간을 절단, 범위 피해 280%', class: 'memory_breaker', tier: 2, type: 'active', element: 'ether', damage: 90, damageScale: 2.8, mpCost: 55, cooldown: 14, castTime: 1.0, range: 5, targetType: 'aoe', aoeRadius: 4, effect: null, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: ['MB_012'], requiredLevel: 50 },
  { code: 'MB_022', name: '기억 폭파', description: '축적 에너지 폭발, 320% 피해 (자가 HP 5% 소모)', class: 'memory_breaker', tier: 2, type: 'active', element: 'ether', damage: 100, damageScale: 3.2, mpCost: 60, cooldown: 20, castTime: 1.2, range: 3, targetType: 'single', aoeRadius: null, effect: { selfDamage: 0.05 }, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: ['MB_014'], requiredLevel: 53 },
  { code: 'MB_023', name: '차원 균열', description: '차원을 찢어 적을 가둠 (이동 불가 4초)', class: 'memory_breaker', tier: 2, type: 'active', element: 'ether', damage: 70, damageScale: 2.5, mpCost: 50, cooldown: 22, castTime: 1.0, range: 5, targetType: 'aoe', aoeRadius: 3, effect: { root: true, duration: 4 }, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: ['MB_011'], requiredLevel: 55 },
  { code: 'MB_024', name: '봉인 흡수', description: '적의 봉인 에너지 흡수, HP/MP 10% 회복', class: 'memory_breaker', tier: 2, type: 'active', element: 'ether', damage: 50, damageScale: 1.8, mpCost: 30, cooldown: 25, castTime: 0.8, range: 3, targetType: 'single', aoeRadius: null, effect: { lifesteal: 0.1, mpSteal: 0.1 }, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: ['MB_004'], requiredLevel: 58 },
  { code: 'MB_025', name: '파괴자의 직감', description: '크리 발동 시 쿨다운 2초 감소', class: 'memory_breaker', tier: 2, type: 'passive', element: 'ether', damage: 0, damageScale: 0, mpCost: 0, cooldown: 0, castTime: 0, range: 0, targetType: 'self', aoeRadius: null, effect: { cdReductionOnCrit: 2 }, maxLevel: 5, levelScaling: PASSIVE_SCALING, prerequisites: ['MB_017'], requiredLevel: 50 },
  { code: 'MB_026', name: '허공의 갈증', description: '적 처치 시 공격력 5% 증가 (최대 25%, 60초)', class: 'memory_breaker', tier: 2, type: 'passive', element: 'ether', damage: 0, damageScale: 0, mpCost: 0, cooldown: 0, castTime: 0, range: 0, targetType: 'self', aoeRadius: null, effect: { killStacking: { perStack: 0.05, maxStacks: 5, duration: 60 } }, maxLevel: 5, levelScaling: PASSIVE_SCALING, prerequisites: ['MB_018'], requiredLevel: 54 },
  { code: 'MB_027', name: '기억 과부하', description: '보스 몬스터에게 피해 12% 증가', class: 'memory_breaker', tier: 2, type: 'passive', element: 'ether', damage: 0, damageScale: 0, mpCost: 0, cooldown: 0, castTime: 0, range: 0, targetType: 'self', aoeRadius: null, effect: { bossBonus: 0.12 }, maxLevel: 5, levelScaling: PASSIVE_SCALING, prerequisites: ['MB_019'], requiredLevel: 56 },
  { code: 'MB_028', name: '에테르 역류', description: 'MP 0 도달 시 HP를 소모하여 스킬 사용 (HP 대 MP 2:1)', class: 'memory_breaker', tier: 2, type: 'passive', element: 'ether', damage: 0, damageScale: 0, mpCost: 0, cooldown: 0, castTime: 0, range: 0, targetType: 'self', aoeRadius: null, effect: { hpToMp: 2 }, maxLevel: 5, levelScaling: PASSIVE_SCALING, prerequisites: ['MB_020'], requiredLevel: 60 },

  // ── 3차 전직: 망각의 군주 (Lv.70+) — 2개 (궁극기 포함) ────────
  { code: 'MB_029', name: '망각의 영역', description: '영역 내 적 전체 공/방 25% 감소 (15초)', class: 'memory_breaker', tier: 3, type: 'active', element: 'ether', damage: 80, damageScale: 2.0, mpCost: 80, cooldown: 30, castTime: 1.5, range: 0, targetType: 'aoe', aoeRadius: 6, effect: { auraDebuff: { attack: -0.25, defense: -0.25, duration: 15 } }, maxLevel: 3, levelScaling: ULTIMATE_SCALING, prerequisites: ['MB_021', 'MB_023'], requiredLevel: 70 },
  { code: 'MB_030', name: '대망각 재현', description: '200년 전 대망각의 힘을 재현 — 범위 내 공격력 600% 에테르 피해 + 5초 행동불능 (자가 최대 HP 10% 소모)', class: 'memory_breaker', tier: 3, type: 'active', element: 'ether', damage: 200, damageScale: 6.0, mpCost: 150, cooldown: 120, castTime: 2.5, range: 0, targetType: 'aoe', aoeRadius: 8, effect: { stun: 5, selfDamage: 0.1 }, maxLevel: 3, levelScaling: ULTIMATE_SCALING, prerequisites: ['MB_029'], requiredLevel: 75 },
];

ALL_SKILLS.push(...memoryBreakerSkills);

// ═══════════════════════════════════════════════════════════════
//  시간 수호자 (time_guardian) — 30 스킬 (P11-03)
//  봉인 12인의 힘 계승. 시간 조작 + 지원/공격 하이브리드.
// ═══════════════════════════════════════════════════════════════

const timeGuardianSkills: SkillSeed[] = [
  // ── 기본 스킬 (Lv.1~29) — 10개 ──────────────────────────────
  { code: 'TG_001', name: '시간의 파동', description: '시간 에너지를 방출하여 전방 적에게 공격력 120% 피해', class: 'time_guardian', tier: 0, type: 'active', element: 'time', damage: 35, damageScale: 1.2, mpCost: 15, cooldown: 5, castTime: 0.3, range: 4, targetType: 'line', aoeRadius: null, effect: null, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: [], requiredLevel: 1 },
  { code: 'TG_002', name: '시간 가속', description: '이동속도 20% 증가 (15초)', class: 'time_guardian', tier: 0, type: 'active', element: 'time', damage: 0, damageScale: 0, mpCost: 20, cooldown: 18, castTime: 0, range: 0, targetType: 'self', aoeRadius: null, effect: { speedBuff: { moveSpeed: 0.2, duration: 15 } }, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: [], requiredLevel: 3 },
  { code: 'TG_003', name: '시간 감속', description: '대상 적의 이동/공격 속도 25% 감소 (8초)', class: 'time_guardian', tier: 0, type: 'active', element: 'time', damage: 0, damageScale: 0, mpCost: 25, cooldown: 15, castTime: 0.5, range: 6, targetType: 'single', aoeRadius: null, effect: { slowDebuff: { moveSpeed: -0.25, attackSpeed: -0.25, duration: 8 } }, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: [], requiredLevel: 5 },
  { code: 'TG_004', name: '시간 인지', description: '회피율 6% 증가', class: 'time_guardian', tier: 0, type: 'passive', element: 'time', damage: 0, damageScale: 0, mpCost: 0, cooldown: 0, castTime: 0, range: 0, targetType: 'self', aoeRadius: null, effect: { evasion: 0.06 }, maxLevel: 5, levelScaling: PASSIVE_SCALING, prerequisites: [], requiredLevel: 8 },
  { code: 'TG_005', name: '봉인의 잔향', description: '적 처치 시 전 스킬 쿨다운 2초 감소', class: 'time_guardian', tier: 0, type: 'passive', element: 'time', damage: 0, damageScale: 0, mpCost: 0, cooldown: 0, castTime: 0, range: 0, targetType: 'self', aoeRadius: null, effect: { onKill: { cooldownReduce: 2 } }, maxLevel: 5, levelScaling: PASSIVE_SCALING, prerequisites: [], requiredLevel: 10 },
  { code: 'TG_006', name: '시간 칼날', description: '응축된 시간을 투사체로 발사, 공격력 140%', class: 'time_guardian', tier: 0, type: 'active', element: 'time', damage: 40, damageScale: 1.4, mpCost: 20, cooldown: 7, castTime: 0.4, range: 8, targetType: 'single', aoeRadius: null, effect: null, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: ['TG_001'], requiredLevel: 12 },
  { code: 'TG_007', name: '시간 방패', description: '3초간 받는 피해 40% 감소', class: 'time_guardian', tier: 0, type: 'active', element: 'time', damage: 0, damageScale: 0, mpCost: 30, cooldown: 20, castTime: 0, range: 0, targetType: 'self', aoeRadius: null, effect: { shield: { damageReduction: 0.4, duration: 3 } }, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: ['TG_004'], requiredLevel: 15 },
  { code: 'TG_008', name: '시간 흐름 파악', description: 'MP 자연 회복량 15% 증가', class: 'time_guardian', tier: 0, type: 'passive', element: 'time', damage: 0, damageScale: 0, mpCost: 0, cooldown: 0, castTime: 0, range: 0, targetType: 'self', aoeRadius: null, effect: { mpRegen: 0.15 }, maxLevel: 5, levelScaling: PASSIVE_SCALING, prerequisites: [], requiredLevel: 18 },
  { code: 'TG_009', name: '시간 연쇄', description: '적 3체에게 차례로 시간 에너지 충격, 각 100% 피해', class: 'time_guardian', tier: 0, type: 'active', element: 'time', damage: 30, damageScale: 1.0, mpCost: 35, cooldown: 12, castTime: 0.6, range: 6, targetType: 'chain', aoeRadius: null, effect: { chainCount: 3 }, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: ['TG_006'], requiredLevel: 22 },
  { code: 'TG_010', name: '시간 적응', description: '환경 패널티(심해 압력 등) 50% 경감', class: 'time_guardian', tier: 0, type: 'passive', element: 'time', damage: 0, damageScale: 0, mpCost: 0, cooldown: 0, castTime: 0, range: 0, targetType: 'self', aoeRadius: null, effect: { envResist: 0.5 }, maxLevel: 5, levelScaling: PASSIVE_SCALING, prerequisites: ['TG_004'], requiredLevel: 25 },

  // ── 1차 전직: 시간 감시자 (Lv.30~49) — 8개 ──────────────────
  { code: 'TG_011', name: '시간 폭발', description: '지정 지점에 시간 폭탄 설치, 3초 후 공격력 200% 범위 폭발', class: 'time_guardian', tier: 1, type: 'active', element: 'time', damage: 60, damageScale: 2.0, mpCost: 40, cooldown: 15, castTime: 0.5, range: 7, targetType: 'aoe', aoeRadius: 3, effect: { delayed: 3 }, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: ['TG_009'], requiredLevel: 30 },
  { code: 'TG_012', name: '시간 치유', description: '아군 1인의 HP를 최대 HP의 15% 회복', class: 'time_guardian', tier: 1, type: 'active', element: 'time', damage: 0, damageScale: 0, mpCost: 45, cooldown: 20, castTime: 1.0, range: 6, targetType: 'single_ally', aoeRadius: null, effect: { heal: 0.15 }, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: ['TG_007'], requiredLevel: 32 },
  { code: 'TG_013', name: '시간 역행장', description: '범위 내 아군 전원 디버프 해제 + 3초간 디버프 면역', class: 'time_guardian', tier: 1, type: 'active', element: 'time', damage: 0, damageScale: 0, mpCost: 50, cooldown: 30, castTime: 0.8, range: 0, targetType: 'aoe_ally', aoeRadius: 5, effect: { cleanse: true, debuffImmunity: 3 }, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: ['TG_012'], requiredLevel: 35 },
  { code: 'TG_014', name: '시간의 눈', description: '은신/투명 적 감지 + 약점 노출 (피격 피해 10% 증가, 10초)', class: 'time_guardian', tier: 1, type: 'active', element: 'time', damage: 0, damageScale: 0, mpCost: 30, cooldown: 25, castTime: 0, range: 10, targetType: 'aoe', aoeRadius: 8, effect: { reveal: true, vulnerability: { amount: 0.1, duration: 10 } }, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: ['TG_003'], requiredLevel: 37 },
  { code: 'TG_015', name: '시간 왜곡', description: '적 투사체 속도 50% 감소 (범위, 8초)', class: 'time_guardian', tier: 1, type: 'active', element: 'time', damage: 0, damageScale: 0, mpCost: 35, cooldown: 22, castTime: 0.3, range: 0, targetType: 'aoe', aoeRadius: 6, effect: { projectileSlow: 0.5, duration: 8 }, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: ['TG_003'], requiredLevel: 40 },
  { code: 'TG_016', name: '시간의 흐름', description: '전투 중 5초마다 HP/MP 1% 자동 회복', class: 'time_guardian', tier: 1, type: 'passive', element: 'time', damage: 0, damageScale: 0, mpCost: 0, cooldown: 0, castTime: 0, range: 0, targetType: 'self', aoeRadius: null, effect: { periodicRegen: { hp: 0.01, mp: 0.01, interval: 5 } }, maxLevel: 5, levelScaling: PASSIVE_SCALING, prerequisites: ['TG_008'], requiredLevel: 42 },
  { code: 'TG_017', name: '가속 연격', description: '공격속도 30% 증가 상태에서 3연속 공격, 각 130%', class: 'time_guardian', tier: 1, type: 'active', element: 'time', damage: 40, damageScale: 1.3, mpCost: 45, cooldown: 14, castTime: 0.2, range: 2, targetType: 'single', aoeRadius: null, effect: { multiHit: 3 }, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: ['TG_011'], requiredLevel: 45 },
  { code: 'TG_018', name: '시간 공명', description: '파티원의 시간 계열 스킬 효과 10% 증가', class: 'time_guardian', tier: 1, type: 'passive', element: 'time', damage: 0, damageScale: 0, mpCost: 0, cooldown: 0, castTime: 0, range: 0, targetType: 'party', aoeRadius: null, effect: { partyTimeBonus: 0.1 }, maxLevel: 5, levelScaling: PASSIVE_SCALING, prerequisites: ['TG_016'], requiredLevel: 48 },

  // ── 2차 전직: 시간 기사 (Lv.50~69) — 10개 ───────────────────
  { code: 'TG_019', name: '시간 참격', description: '시간을 응축한 일격, 공격력 220% + 2초 스턴', class: 'time_guardian', tier: 2, type: 'active', element: 'time', damage: 70, damageScale: 2.2, mpCost: 50, cooldown: 14, castTime: 0.5, range: 3, targetType: 'single', aoeRadius: null, effect: { stun: 2 }, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: ['TG_017'], requiredLevel: 50 },
  { code: 'TG_020', name: '되감기', description: '자신의 HP/MP를 5초 전 상태로 복원', class: 'time_guardian', tier: 2, type: 'active', element: 'time', damage: 0, damageScale: 0, mpCost: 60, cooldown: 45, castTime: 0, range: 0, targetType: 'self', aoeRadius: null, effect: { rewind: { seconds: 5 } }, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: ['TG_012'], requiredLevel: 52 },
  { code: 'TG_021', name: '시간 분열', description: '크리티컬 시 추가 타격 1회 (원본 피해의 30%)', class: 'time_guardian', tier: 2, type: 'passive', element: 'time', damage: 0, damageScale: 0, mpCost: 0, cooldown: 0, castTime: 0, range: 0, targetType: 'self', aoeRadius: null, effect: { onCrit: { bonusHit: 0.3 } }, maxLevel: 5, levelScaling: PASSIVE_SCALING, prerequisites: ['TG_017'], requiredLevel: 54 },
  { code: 'TG_022', name: '시간 감옥', description: '대상 적을 4초간 시간 정지 (보스 2초). 정지 중 무적', class: 'time_guardian', tier: 2, type: 'active', element: 'time', damage: 0, damageScale: 0, mpCost: 55, cooldown: 35, castTime: 0.8, range: 6, targetType: 'single', aoeRadius: null, effect: { timeFreeze: { normal: 4, boss: 2 } }, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: ['TG_015'], requiredLevel: 55 },
  { code: 'TG_023', name: '시간 폭풍', description: '범위 내 적에게 공격력 180% 피해 + 이동속도 40% 감소 (6초)', class: 'time_guardian', tier: 2, type: 'active', element: 'time', damage: 55, damageScale: 1.8, mpCost: 55, cooldown: 18, castTime: 0.7, range: 0, targetType: 'aoe', aoeRadius: 5, effect: { slow: { moveSpeed: -0.4, duration: 6 } }, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: ['TG_011'], requiredLevel: 57 },
  { code: 'TG_024', name: '시간 연결', description: '아군 1인과 시간 연결, 10초간 HP 피해 분담 (50:50)', class: 'time_guardian', tier: 2, type: 'active', element: 'time', damage: 0, damageScale: 0, mpCost: 40, cooldown: 30, castTime: 0.5, range: 8, targetType: 'single_ally', aoeRadius: null, effect: { link: { damageShare: 0.5, duration: 10 } }, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: ['TG_013'], requiredLevel: 59 },
  { code: 'TG_025', name: '시간 축적', description: '스킬 사용 시마다 "시간 게이지" 충전, 10스택 시 다음 스킬 쿨다운 0', class: 'time_guardian', tier: 2, type: 'passive', element: 'time', damage: 0, damageScale: 0, mpCost: 0, cooldown: 0, castTime: 0, range: 0, targetType: 'self', aoeRadius: null, effect: { stackMechanic: { maxStacks: 10, onMax: 'resetCooldown' } }, maxLevel: 5, levelScaling: PASSIVE_SCALING, prerequisites: ['TG_005'], requiredLevel: 61 },
  { code: 'TG_026', name: '시간 반사', description: '피격 시 20% 확률로 받은 피해의 50%를 적에게 반사', class: 'time_guardian', tier: 2, type: 'passive', element: 'time', damage: 0, damageScale: 0, mpCost: 0, cooldown: 0, castTime: 0, range: 0, targetType: 'self', aoeRadius: null, effect: { reflect: { chance: 0.2, ratio: 0.5 } }, maxLevel: 5, levelScaling: PASSIVE_SCALING, prerequisites: ['TG_007'], requiredLevel: 63 },
  { code: 'TG_027', name: '시간 가속장', description: '범위 내 아군 전원 공격속도 25% 증가 (12초)', class: 'time_guardian', tier: 2, type: 'active', element: 'time', damage: 0, damageScale: 0, mpCost: 50, cooldown: 25, castTime: 0.5, range: 0, targetType: 'aoe_ally', aoeRadius: 6, effect: { attackSpeedBuff: { amount: 0.25, duration: 12 } }, maxLevel: 5, levelScaling: ACTIVE_SCALING, prerequisites: ['TG_018'], requiredLevel: 65 },
  { code: 'TG_028', name: '시간의 무게', description: '보스 몬스터에게 추가 피해 15%', class: 'time_guardian', tier: 2, type: 'passive', element: 'time', damage: 0, damageScale: 0, mpCost: 0, cooldown: 0, castTime: 0, range: 0, targetType: 'self', aoeRadius: null, effect: { bossBonus: 0.15 }, maxLevel: 5, levelScaling: PASSIVE_SCALING, prerequisites: ['TG_021'], requiredLevel: 68 },

  // ── 3차 전직: 시대의 지배자 (Lv.70+) — 2개 (궁극기 포함) ────
  { code: 'TG_029', name: '시간 정지', description: '3초간 범위 내 모든 적 행동 정지 (보스 1초)', class: 'time_guardian', tier: 3, type: 'active', element: 'time', damage: 0, damageScale: 0, mpCost: 80, cooldown: 60, castTime: 1.0, range: 0, targetType: 'aoe', aoeRadius: 8, effect: { timeStop: { normal: 3, boss: 1 } }, maxLevel: 3, levelScaling: ULTIMATE_SCALING, prerequisites: ['TG_022', 'TG_023'], requiredLevel: 70 },
  { code: 'TG_030', name: '대망각의 역류', description: '3,200년의 봉인 에너지를 해방. 범위 내 적 공격력 500% + 전 스탯 30% 감소 (5초). 아군 전원 HP 20% 회복', class: 'time_guardian', tier: 3, type: 'active', element: 'time', damage: 150, damageScale: 5.0, mpCost: 100, cooldown: 120, castTime: 2.0, range: 0, targetType: 'aoe', aoeRadius: 10, effect: { debuff: { allStats: -0.3, duration: 5 }, partyHeal: 0.2 }, maxLevel: 3, levelScaling: ULTIMATE_SCALING, prerequisites: ['TG_029'], requiredLevel: 75 },
];

ALL_SKILLS.push(...timeGuardianSkills);
