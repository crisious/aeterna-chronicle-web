...
const COMBO_DEFINITIONS: ComboDefinition[] = [
  ...
  // ═══ 기억 파괴자 (memory_breaker) — 5개 (E-S1) ═══
  {
    id: 'mb_shatter_storm_combo',
    name: '파쇄 폭풍',
    description: '기억 파쇄 → 광역 파동 → 파쇄 폭풍 = 광역 침묵',
    classId: 'memory_breaker',
    skillSequence: ['mb_memory_shatter', 'mb_wide_wave', 'mb_shatter_storm'],
    damageBonus: 45,
    statusEffect: 'silence',
    statusEffectChance: 100,
    statusEffectValue: 0,
    bonusDescription: '광역 침묵 + 데미지 45% 증가',
  },
  {
    id: 'mb_rage_burst',
    name: '광폭 폭주',
    description: '분노 폭주 → 분노의 쇄도 → 광란의 일격 = 자가 ATK 100% 증가',
    classId: 'memory_breaker',
    skillSequence: ['mb_rage_rampage', 'mb_rage_surge', 'mb_frenzy_strike'],
    damageBonus: 60,
    statusEffect: null,
    statusEffectChance: 0,
    statusEffectValue: 100,
    bonusDescription: '자가 ATK 100% 증가 (10초) + 데미지 60% 증가',
  },
  {
    id: 'mb_memory_drain_chain',
    name: '기억 약탈',
    description: '기억 흡수: 공격 → 기억 흡수: 방어 → 기억 약탈 = HP/MP 흡수',
    classId: 'memory_breaker',
    skillSequence: ['mb_memory_drain_atk', 'mb_memory_drain_def', 'mb_memory_plunder'],
    damageBonus: 30,
    statusEffect: null,
    statusEffectChance: 0,
    statusEffectValue: 50,
    bonusDescription: '데미지의 50% HP + MP 흡수',
  },
  {
    id: 'mb_destruction_finale',
    name: '파괴 종결',
    description: '연쇄 파쇄 → 최종 파괴 → 기억 심판 = 처형',
    classId: 'memory_breaker',
    skillSequence: ['mb_chain_shatter', 'mb_final_destruction', 'mb_memory_judgment'],
    damageBonus: 80,
    statusEffect: null,
    statusEffectChance: 0,
    statusEffectValue: 30,
    bonusDescription: 'HP 30% 이하 처형 + 데미지 80% 증가',
  },
  {
    id: 'mb_ground_quake',
    name: '대지 진동',
    description: '대지 분쇄 → 파쇄 도약 → 대파쇄 = 광역 출혈',
    classId: 'memory_breaker',
    skillSequence: ['mb_ground_smash', 'mb_shatter_leap', 'mb_great_shatter'],
    damageBonus: 50,
    statusEffect: 'bleed',
    statusEffectChance: 100,
    statusEffectValue: 8,
    bonusDescription: '광역 출혈 (8 dot/초) + 데미지 50%',
  },

  // ═══ 시간 수호자 (time_guardian) — 5개 (E-S1) ═══
  {
    id: 'tg_time_lock',
    name: '시간 봉인',
    description: '시간 정지 → 감속 필드 → 시간 폭발 = 광역 동결',
    classId: 'time_guardian',
    skillSequence: ['tg_time_stop', 'tg_slow_field', 'tg_time_explosion'],
    damageBonus: 50,
    statusEffect: 'freeze',
    statusEffectChance: 100,
    statusEffectValue: 0,
    bonusDescription: '광역 동결 (3초) + 데미지 50% 증가',
  },
  {
    id: 'tg_rewind_chain',
    name: '시간 역행',
    description: '되감기 → 시간 치유 → 시간 도약 = 파티 풀 회복',
    classId: 'time_guardian',
    skillSequence: ['tg_rewind', 'tg_time_heal', 'tg_time_leap'],
    damageBonus: 0,
    statusEffect: null,
    statusEffectChance: 0,
    statusEffectValue: 50,
    bonusDescription: '파티 전원 HP 50% 회복 + 모든 디버프 제거',
  },
  {
    id: 'tg_accel_burst',
    name: '가속 연사',
    description: '가속 → 시간 탄환 → 시간 복제 = 5연속 사격',
    classId: 'time_guardian',
    skillSequence: ['tg_accel', 'tg_time_bullet', 'tg_time_clone'],
    damageBonus: 40,
    statusEffect: null,
    statusEffectChance: 0,
    statusEffectValue: 5,
    bonusDescription: '단일 대상 5연속 사격 + 데미지 40% 증가',
  },
  {
    id: 'tg_temporal_stasis',
    name: '시간 정지장',
    description: '시간 장벽 → 시간 정지 → 감속 필드 = 적 행동 불가',
    classId: 'time_guardian',
    skillSequence: ['tg_time_barrier', 'tg_time_stop', 'tg_slow_field'],
    damageBonus: 20,
    statusEffect: 'stun',
    statusEffectChance: 100,
    statusEffectValue: 0,
    bonusDescription: '적 전체 기절 (4초) + 파티 보호막',
  },
  {
    id: 'tg_chronos_judgment',
    name: '연대기 심판',
    description: '되감기 → 시간 폭발 → 시간 도약 = 광역 시간 데미지',
    classId: 'time_guardian',
    skillSequence: ['tg_rewind', 'tg_time_explosion', 'tg_time_leap'],
    damageBonus: 70,
    statusEffect: 'slow',
    statusEffectChance: 100,
    statusEffectValue: 50,
    bonusDescription: '광역 감속 50% + 데미지 70% 증가',
  },

  // ═══ 허공의 방랑자 (void_wanderer) — 5개 (E-S1) ═══
  {
    id: 'vw_dimension_cut',
    name: '차원 절단',
    description: '공간 이동 → 차원 절단 → 공간 압축 = 회피 불가',
    classId: 'void_wanderer',
    skillSequence: ['vw_spatial_shift', 'vw_dimension_cut', 'vw_spatial_compress'],
    damageBonus: 55,
    statusEffect: 'silence',
    statusEffectChance: 80,
    statusEffectValue: 0,
    bonusDescription: '회피 불가 처치 + 80% 침묵',
  },
  {
    id: 'vw_void_torrent',
    name: '허공의 격류',
    description: '허공의 손 → 허공 연쇄 → 허공의 문 = 다단 흡인',
    classId: 'void_wanderer',
    skillSequence: ['vw_void_hand', 'vw_void_chain', 'vw_void_gate'],
    damageBonus: 60,
    statusEffect: null,
    statusEffectChance: 0,
    statusEffectValue: 0,
    bonusDescription: '적 전체를 한 곳으로 흡인 + 데미지 60% 증가',
  },
  {
    id: 'vw_spatial_distortion_combo',
    name: '공간 왜곡',
    description: '공간 왜곡 → 공간 분열 → 차원 절단 = 분신 데미지',
    classId: 'void_wanderer',
    skillSequence: ['vw_spatial_distortion', 'vw_spatial_fission', 'vw_dimension_cut'],
    damageBonus: 45,
    statusEffect: null,
    statusEffectChance: 0,
    statusEffectValue: 3,
    bonusDescription: '3 분신 추가 공격 + 데미지 45% 증가',
  },
  {
    id: 'vw_dimension_leap_chain',
    name: '차원 도약 연계',
    description: '차원 도약 → 차원 방벽 → 공간 이동 = 무적 회피',
    classId: 'void_wanderer',
    skillSequence: ['vw_dimension_leap', 'vw_dimension_barrier', 'vw_spatial_shift'],
    damageBonus: 0,
    statusEffect: null,
    statusEffectChance: 0,
    statusEffectValue: 3,
    bonusDescription: '3초 무적 + 다음 공격 크리티컬 확정',
  },
  {
    id: 'vw_void_collapse',
    name: '공허 붕괴',
    description: '허공의 문 → 공간 압축 → 허공 연쇄 = 광역 멸절',
    classId: 'void_wanderer',
    skillSequence: ['vw_void_gate', 'vw_spatial_compress', 'vw_void_chain'],
    damageBonus: 90,
    statusEffect: 'curse',
    statusEffectChance: 100,
    statusEffectValue: 0,
    bonusDescription: '광역 저주 + 데미지 90% 증가',
  },
];
