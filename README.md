...
md 기획문서  10항목 → 8건 수정 (클래스 5종/던전 30개/챕터 7개/DB 70+모델 현행화)
```
...
| 월드맵 | 10개 (7지역 + 마스터 3) |
| 지역 | 8개 (40개 존) — 시즌3 기억의 심연 추가 |
| 챕터 | 7개 |
| 엔딩 | 4+1종 (히든 엔딩D 유물 12개 문서화 완료) |
| 던전 | 30개 (3난이도) — 심연 5개 추가 |
| 몬스터 | 163개 (일반 100/엘리트 30/보스 22/필드보스 5/레이드 6) |
| 스킬 | 150개 (5클래스 × 30) — 시간 수호자 추가 |
| 검증 리포트 | 55개+ (P0~P8) |
...
| 코스메틱 | 150개 (스킨/무기/펫/마운트/이모트/칭호/오라) — 시즌3 50개 추가 |
