...
에테르나 크로니클은 2026년 Steam에서 $14.99(₩16,500)에 출시될 예정이다. 현재 Steam 스토어 페이지에서 위시리스트에 추가할 수 있다.

---

### 인용문

> "1인 개발은 한계가 아니라 선택입니다. 모든 기획, 모든 코드, 모든 에셋에 제 철학이 담겨 있습니다. 에테르나 크로니클은 '잊혀진 것들의 가치'에 대한 이야기입니다."  
> — **Crisious**, 개발자
...
| 이메일 | [TBD] |
| 웹사이트 | [TBD] |
| 프레스 킷 | [press_kit 링크 TBD] |
| Steam 스토어 | [Steam 링크 TBD] |
| Discord | [TBD] |
...
| # | 매체 | 분야 | 비고 |
|---|------|------|------|
| 1 | 인벤 (Inven) | 종합 게임 | 한국 최대 게임 커뮤니티 |
| 2 | 게임메카 (GameMeca) | 종합 게임 | 뉴스 + 리뷰 |
| 3 | 디스이즈게임 (This is Game) | 종합 게임 | 인디 게임 섹션 활성 |
| 4 | 게임톡 (GameTalk) | 종합 게임 | 인디 게임 전문 코너 |
| 5 | 게임포커스 (GameFocus) | 종합 게임 | 뉴스 중심 |
| 6 | 게임인사이트 | 인디 특화 | 인디 게임 전문 매체 |
| 7 | 게임와치 (GameWatch) | 종합 게임 | 리뷰 + 프리뷰 |
| 8 | 루리웹 (Ruliweb) | 게임 커뮤니티 | 유저 리뷰 영향력 |
| 9 | IGN 코리아 | 글로벌 게임 | 국제적 인지도 |
| 10 | 게임스팟 코리아 | 글로벌 게임 | 리뷰 중심 |
| 11 | 게임조선 | 게임 뉴스 | 주요 게임 언론 |
| 12 | 게임동아 | 게임 뉴스 | IT동아 게임 섹션 |
| 13 | 게임샷 | 종합 게임 | 뉴스 + 인터뷰 |
| 14 | 게임피아 | 인디/PC | 인디 게임 리뷰 |
| 15 | 게임플 | 게임 뉴스 | 신작 소개 |
...
Aeterna Chronicle will launch on Steam at $14.99 USD in 2026. Wishlist now on the Steam store page.

---

### Quote

> "Solo development isn't a limitation — it's a choice. Every design decision, every line of code, every asset carries my philosophy. Aeterna Chronicle is a story about the value of what has been forgotten."  
> — **Crisious**, Developer

---

## Distribution Targets (Global Media 20+)

| # | Outlet | Region | Notes |
|---|--------|--------|-------|
| 1 | IGN | Global | Largest gaming media |
| 2 | GameSpot | Global | Reviews + previews |
| 3 | PC Gamer | PC Focus | RPG coverage strong |
| 4 | Rock Paper Shotgun | PC/Indie | Indie game coverage |
| 5 | Kotaku | Global | Culture + games |
| 6 | Eurogamer | Europe | Strong indie coverage |
| 7 | Polygon | Global | Feature-driven |
| 8 | Destructoid | Global | Indie-friendly |
| 9 | GamesRadar+ | Global | News + reviews |
| 10 | The Gamer | Global | Lists + features |
| 11 | Siliconera | Asia/RPG | JRPG/Asia specialty |
| 12 | RPG Site | RPG Focus | RPG-dedicated outlet |
| 13 | Indie Game Enthusiast | Indie | Indie-exclusive |
| 14 | IndieDB | Indie | Community + press |
| 15 | Touch Arcade | Web/Mobile | Web gaming coverage |
| 16 | DualShockers | Global | Anime/RPG coverage |
| 17 | Famitsu | Japan | Japanese market |
| 18 | 4Gamer.net | Japan | Japanese gaming |
| 19 | Gematsu | Japan/Global | JRPG community |
| 20 | WorthPlaying | Global | Indie reviews |
