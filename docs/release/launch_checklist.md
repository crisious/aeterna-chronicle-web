...
- [x] Windows 빌드 설치 + 실행 테스트
- [x] macOS 빌드 설치 + 실행 테스트 (ARM + x64)
- [x] Linux 빌드 설치 + 실행 테스트 (Ubuntu 20.04+)
...
- [x] GDPR 구현(P9-12) 동작 확인 — 데이터 삭제 API / 내보내기 / 동의 관리
